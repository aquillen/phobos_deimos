...
// spacing set by parameter dist: no closer particles allowed
// set z=0 everywhere
void rand_rectangle_2d(struct reb_simulation* const r, double dist, 
       double ax, double by, double total_mass)
{
   struct reb_particle pt;
...
void connect_springs_dist_nodemax(struct reb_simulation* const r, 
      double h_dist_min,  double h_dist_max,
      int i0, int imax,
...
// Lx,Ly,Lz = r_ij
// ignore damping
void spring_force_k_one(struct reb_simulation* const r,int i_s,
...
void stretch(struct reb_simulation* const r,int il,int ih,
...
void eigenvecs(double Cxx,double Cyy,double Czz,double Cxy, double Cyz, double Cxz,
    double eigv,double *eigvecx,double *eigvecy, double *eigvecz){
...
void vec_mul(double Axx, double Axy, double Axz,
